# Support for Output Descriptors in Pepecoin Core

Since Pepecoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `pepe1...` for mainnet or `tpepe1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Pepecoin Core wallets, a convenience function `combo` is
