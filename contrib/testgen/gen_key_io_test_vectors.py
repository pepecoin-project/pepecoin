...
bech32_templates = [
  ...
  ('pepe',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('pepe',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('pepe',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('pepe',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tpepe',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tpepe',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tpepe',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tpepe',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tpepe',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tpepe',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tpepe',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tpepe',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rpepe',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rpepe',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rpepe',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rpepe', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tpepe',   17, 32, Encoding.BECH32M, False, False, False),
  ('rpepe',  3,  1, Encoding.BECH32M, False, False, False),
  ('pepe',   15, 41, Encoding.BECH32M, False, False, False),
  ('tpepe',    0, 16, Encoding.BECH32,  False, False, False),
  ('rpepe',  0, 32, Encoding.BECH32,  True,  False, False),
  ('pepe',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tpepe',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rpepe',  0, 20, Encoding.BECH32,  False, False, True),
  ('pepe',    0, 20, Encoding.BECH32M, False, False, False),
  ('tpepe',    0, 32, Encoding.BECH32M, False, False, False),
  ('rpepe',  0, 20, Encoding.BECH32M, False, False, False),
  ('pepe',    1, 32, Encoding.BECH32,  False, False, False),
  ('tpepe',    2, 16, Encoding.BECH32,  False, False, False),
  ('rpepe', 16, 20, Encoding.BECH32,  False, False, False),
]
