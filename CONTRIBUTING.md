...
The Pepecoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Pepecoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/pepecoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to pepecoin-qt
...
The following applies to code changes to the Pepecoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Pepecoin
Network Protocol consensus changes.

Whether a pull request is merged into Pepecoin Core rests with the project merge
...
Patches that change Pepecoin consensus rules are considerably more involved than
...
The project leader is the release manager for each Pepecoin Core release.
