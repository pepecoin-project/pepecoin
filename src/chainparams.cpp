...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.pepecoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.pepecointools.com");
        vSeeds.emplace_back("dnsseed.pepecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.pepecointools.com");
        vSeeds.emplace_back("seed-b.pepecoin.loshan.co.uk");
