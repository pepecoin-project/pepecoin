...
{
    const char* pszTimestamp = "28/Aug/2022 Bitcoin risks worst August since 2015 as hodlers brace for Septembear";
    const CScript genesisOutputScript = CScript() << ParseHex("040aa38658b6fd6ff9c0edc92db3f6836b0274961c3c5864c369ffb72f650c74493ba9cff905582f46b0bcebe4718e90dd52953a872979a6211155cc5a4f5f337c") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 10 * 15;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartHeight = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
        ...
        genesis = CreateGenesisBlock(1661738291, 1713155, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x685d8d6f50c2a3db7ce9e87ca3e0cde6d2f3cc2b221378106f12ff60198e4885"));
        assert(genesis.hashMerkleRoot == uint256S("0x118754c3394720c2642ec827b05b450312ee2b8829d978faf7be75ce0715c511"));
        ...
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,47);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1661738834, 502934, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8c1869765f7cbba7bf91551ed7e47e27c5fc1f45224e30f974a3cecd656abf32"));
        assert(genesis.hashMerkleRoot == uint256S("0x118754c3394720c2642ec827b05b450312ee2b8829d978faf7be75ce0715c511"));
        ...
        checkpointData = {
            {
                {0, uint256S("54e6075affe658d6574e04c9245a7920ad94dc5af8f5b37fd9a094e317769740")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1661739122, 1, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc4f499c8b180edc421fe24001eb34f668ec42869e00ab1e76491ba011e3676dc"));
        assert(genesis.hashMerkleRoot == uint256S("0x118754c3394720c2642ec827b05b450312ee2b8829d978faf7be75ce0715c511"));
