...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pepecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pepecoin-tx [options] <hex-tx> [commands]  Update hex-encoded pepecoin transaction\n" +
            "or:     pepecoin-tx [options] -create [commands]   Create hex-encoded pepecoin transaction\n" +
            "\n";
