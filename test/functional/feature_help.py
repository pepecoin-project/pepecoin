...
"""Verify that starting pepecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pepecoin with -h for help text")
        ...
        self.log.info("Start pepecoin with -version for version information")
        ...
        self.log.info("Start pepecoind with -fakearg to make sure it does not start")
